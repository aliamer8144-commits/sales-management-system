    ...
    return (
      <div className="p-4 pb-24">
        <div className="flex items-center justify-between mb-4">
          <Button variant="ghost" onClick={() => setSelectedSalesInvoice(null)}>
        ...
        <Card className="shadow-md">
          <CardHeader className="bg-gradient-to-l from-teal-500 to-emerald-600 text-white rounded-t-lg">
            ...
            <p className="text-sm text-white/80">
              {formatYemenDateTime(selectedSalesInvoice.createdAt)}
            </p>
          </CardHeader>
          <CardContent className="pt-4">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {selectedSalesInvoice.items.map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="font-bold"><CurrencyDisplay amount={item.quantity * item.salePrice} symbolSize={12} /></p>
                  </div>
                ))}
              </div>
              <Separator />
              <div className="flex justify-between">
                ...
                <span className="font-bold"><CurrencyDisplay amount={selectedSalesInvoice.totalAmount} symbolSize={14} /></span>
              </div>
              {isAdmin && (
                <div className="flex justify-between">
                  <span className="text-gray-500">الربح</span>
                  <span className="font-bold text-green-600">
                    <CurrencyDisplay amount={selectedSalesInvoice.totalProfit} symbolSize={12} />
                  </span>
                </div>
              )}
      ...
      <div className="p-4 pb-24">
        ...
        <Card className="shadow-md">
          <CardHeader className="bg-gradient-to-l from-amber-500 to-orange-600 text-white rounded-t-lg">
            ...
            <p className="text-sm text-white/80">
              {formatYemenDateTime(selectedPurchaseInvoice.createdAt)}
            </p>
          </CardHeader>
          <CardContent className="pt-4">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {selectedPurchaseInvoice.items.map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="font-bold"><CurrencyDisplay amount={item.quantity * item.purchasePrice} symbolSize={12} /></p>
                  </div>
                ))}
              </div>
              <Separator />
              <div className="flex justify-between">
                <span className="text-gray-500">الإجمالي</span>
                <span className="font-bold"><CurrencyDisplay amount={selectedPurchaseInvoice.totalAmount} symbolSize={14} /></span>
              </div>
      ...
      <div className="p-4 pb-24">
        ...
        {hasActiveFilters && (
          <div className="flex flex-wrap gap-2 mb-4">
            {startDate && (
              <ActiveFilterBadge
                label={`من: ${formatYemenDate(startDate)}${startTime ? ` ${startTime}` : ''}`}
                onRemove={() => clearFilter('startDate')}
              />
            )}
            {endDate && (
              <ActiveFilterBadge
                label={`إلى: ${formatYemenDate(endDate)}${endTime ? ` ${endTime}` : ''}`}
