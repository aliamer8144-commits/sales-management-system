...
export function CustomerDetailsPage({ 
  ...
  const fetchStatement = useCallback(async () => {
    ...
    try {
      ...
      // Send the datetime value directly without timezone conversion
      // The datetime-local input gives us values like "2024-03-12T10:30"
        ...
        <Card className="shadow-sm">
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                <Label className="text-xs text-gray-500">من تاريخ ووقت</Label>
                <Input
                  type="datetime-local"
                  value={startDateTime}
              ...
              <div>
                <Label className="text-xs text-gray-500">إلى تاريخ ووقت</Label>
                <Input
                  type="datetime-local"
                  value={endDateTime}
