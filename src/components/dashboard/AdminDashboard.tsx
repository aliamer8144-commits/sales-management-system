    ...
    <div className="p-4 space-y-6 pb-24">
      ...
      <div className="grid grid-cols-2 gap-4">
        <StatCard
          ...
          icon={ShoppingCart}
        />
        <StatCard title="إجمالي الأرباح" value={`${stats.totalProfit.toLocaleString()} ﷼`} icon={Package} />
        <StatCard title="رأس المال" value={`${stats.totalCapital.toLocaleString()} ﷼`} icon={Wallet} />
        <StatCard
